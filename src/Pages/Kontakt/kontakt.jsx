                        ...
                        <form ref={form} onSubmit={sendEmail}>
                            ...
                            <textarea id="message-box" name="message" placeholder="Poruke" />
                             <div className="check-btn">
                                <label><input id="checkbox" className="checkBoxBtn" type="checkbox" required></input> <a className="link-b" target="_blank" href={require("../../Docs/politikaPrivatnosti.pdf")}>Prihvati politiku privatnosti </a></label>
                            </div>
