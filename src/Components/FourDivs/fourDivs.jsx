    ...
    return (
        <div className="fourDivs">
            ...
            <div className="img-of-delivery">
                ...
                <a className="homepage-aFourDivs" href="../../Pages/Zakazi"> <h2 className="homepage-aFourDivs">Brže vreme isporuke</h2></a>
            </div>

            <div className="img-of-delivery">
                <div className="dev-img"><img className="slika" src={slika2} alt="slika2"></img></div>
                <a className="homepage-aFourDivs" href="../../Pages/Zakazi"><h2 className="homepage-aFourDivs">Neka pošiljka stigne do Vas</h2></a>
            </div>

            <div className="img-of-delivery">
                <div className="dev-img"><img className="slika"  src={slika3} alt="slika3"></img></div>
                <a className="homepage-aFourDivs" href="../../Pages/Uslugee"><h2 className="homepage-aFourDivs">Flexibilna dostava</h2></a>
               
            </div>

            <div className="img-of-delivery">
                <div className="dev-img"><img className="slika" src={slika4} alt="slika4"></img></div>
                <a className="homepage-aFourDivs" href="../../Pages/Uslugee"> <h2 className="homepage-aFourDivs">Pošiljka više nije Vaša briga</h2></a>
            </div>
